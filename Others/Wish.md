数组中找popular number，地里有面经，follow up要用binary search。第二轮其实是加面，因为楼主不在湾区去onsite要飞过去，所以加面一轮看我值不值机票钱。题目是给一堆名字之间的关系，比如a sister b， b mother c之类，给一个起始名字和一个结束名字，print出所有从起始到结束的关系path。地里面经题。
